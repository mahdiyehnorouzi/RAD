...
export const en = {
  ...
  ordersEntryEyebrow: "MAKING PATH",
  ordersEntryTitle: "What stage the piece is in, and what happens next.",
  ordersEntryBody:
    "Request, review, quote, deposit, making, pre-kiln, firing, reveal, and shipping — as the piece’s biography.",
  ...
  makingEmpty: "You have not submitted a design for making yet.",
  makingEmptyBody: "Submit a design from the studio to begin artist review.",
  makingBack: "Back to making paths",
  ...
  shopStageReceived: "Order received",
  shopStageApproved: "Workshop approved",
  shopStageForming: "Forming",
  shopStageDrying: "Drying",
  shopStageGlazing: "Glazing",
  shopStageFiring: "Firing",
  shopStageQuality: "Quality check",
  shopStageShipped: "Shipped",
  shopStageDelivered: "Delivered",
  ordersShopNote: "This page is for ready-made shop orders. Follow a custom commission on the making path.",
  makingCustomNote: "This page is only your custom commissions — not archive purchases.",
