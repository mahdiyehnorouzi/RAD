...
export const en = {
  ...
  studioEyebrow: "RAD × INTELLIGENT IMAGING",
  ...
  step1Body: "Write the idea, use, and feeling you have in mind.",
  step2Title: "Imagine it",
  step2Body: "AI visualizes a first image of what you described.",
  step3Title: "Finish it with us",
  step3Body: "A RAD artist reviews whether it can be made, and the details.",
  step4Title: "Yours alone",
  step4Body: "The work is made by hand and numbered.",
  ...
  createPathBody:
    "From the first idea and image through artist review and making a personal piece.",
  ...
  ordersEntryTitle: "Follow the making of your work.",
  ordersEntryBody:
    "From concept approval and maker selection through making, signing, and shipping.",
