...
export const en = {
  ...
  step1Body: "Write the idea, memory, and feeling you have in mind.",
  step2Title: "AI imagines",
  step2Body: "The first image is intention, not a promise that the object will match.",
  step3Title: "Artist’s hand",
  step3Body: "The maker reinterprets form for balance, making, and material truth.",
  step4Title: "Difference Portrait",
  step4Body: "What fire and hand produced is recorded. Difference is the signature.",
  ...
  note2: "The artist may reinterpret the form.",
  note3: "Material and firing keep the last word.",
  preset1: "Earth tones",
  preset2: "Free lines",
  ...
  workshopBody:
    "This is making, not store administration. Orders are grouped by action needed, waiting on the customer, and production stage.",
