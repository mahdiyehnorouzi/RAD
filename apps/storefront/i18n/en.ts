...
export const en = {
  ...
  startCustomDesign: "Start a custom design",
  ...
  placeDemoOrder: "Continue to payment",
  orderSuccessTitle: "Your request is recorded.",
  orderSuccessBody:
    "Your order is placed. Transfer the amount to the listed card and confirm payment.",
  returnHome: "Return home",
  toman: "USD",
  designerTitle1: "A piece that does not",
  designerTitle2: "exist yet.",
  designerBody:
    "First say what is in your mind. RAD makes an idea card from it, not a finished picture.",
  designerFreeIdea:
    "The idea card is the starting point for the maker. The object comes from the kiln.",
  designerFreeTitle: "Start your RAD",
  ...
  evidenceBody: "Every material keeps its own rhythm and trace.",
  evidenceMeta: "Video 00:04 — Tehran / material, form, finish, signature",
  ...
  ownPathIndex: "I — OWN",
  ownPathTitle: "Ready works",
  ownPathBody: "Choose a finished object that is already in the workshop.",
  ...
  certificateEyebrow: "Work record",
  certificateTitle: "Every RAD has a life",
  certificateArtist: "Made by the artist",
  certificateMaterial: "Material and making stages recorded",
  certificateNumber: "A unique number and the 1/1 mark",
  certificatePhotoAlt: "A finished work in the workshop",
  homeProcessEyebrow: "Commission path",
  homeProcessLead: "From description to making — only if the artist accepts.",
  homeProcessIndex1: "01",
  homeProcessIndex2: "02",
  homeProcessIndex3: "03",
  homeProcessStep1: "Describe your idea",
  homeProcessStep2: "See the artist's proposal",
  homeProcessStep3: "Follow the making path",
  homeProcessBody1:
  ...
  differenceBody:
    "Drag: idea, hand, material, RAD. The distances stay visible.",
  ...
  manualPaymentCopyCard: "Copy card number",
  manualPaymentCardCopied: "Card number copied.",
  manualPaymentAmount: "Amount due: {amount}",
  ...
  designerStepSpark: "Mind",
  designerStepFreedom: "Freedom",
  ...
  designerSparkHelp:
    "It does not have to be complete. A sentence, a crooked line, a voice, or two colours is enough.",
  ...
  designerVoice: "Voice",
  designerPhoto: "Photo",
  designerColors: "Colours",
  designerFeeling: "Feeling",
  designerDrawHint: "Draw badly with a finger or mouse. Bad lines are better.",
  designerDrawClear: "Clear the sketch",
  designerVoiceStart: "Start recording",
  designerVoiceStop: "Stop",
  designerVoiceRecorded: "Voice note saved",
  designerVoiceNeedMic: "Microphone permission is needed to record.",
  designerColorLimit: "Up to three colours",
  designerFreedomTitle: "How free should the maker's hand be?",
  designerFreedomLegend: "Maker freedom",
  designerFreedomLow: "Close to what I sent",
  designerFreedomHigh: "Surprise me",
  designerFreedomShare: "My RAD freedom: {value}",
  ...
  ideaCardHasVoice: "Voice note",
  ideaCardHasWriting: "Writing",
  titlePassport: "RAD Passport",
  footerPassport: "Passports",
  passportEyebrow: "Object passport",
  passportIndexEyebrow: "Lives in the archive",
  passportIndexTitle: "Every RAD has a life",
  passportIndexBody:
    "When a work is made, a page remains for its path, material, hand, and where it is now.",
  passportOnce: "This RAD was made only once.",
  passportOnceBody: "Here you can see its path.",
  passportLedger: "RAD record",
  passportMaker: "Maker",
  passportDate: "Date created",
  passportClay: "Clay / material",
  passportGlaze: "Glaze / colours",
  passportDimensions: "Dimensions",
  passportFiring: "Firing",
  passportInspiration: "Original inspiration",
  passportSketch: "First sketch",
  passportConstruction: "Photos during construction",
  passportChanges: "Unexpected changes",
  passportFinal: "Final photographs",
  passportOwner: "Owner",
  passportCity: "City",
  passportCare: "Care",
  passportWhere: "Where is this RAD now?",
  passportWhereEyebrow: "After making",
  passportCopyLink: "Copy passport link",
  passportCopied: "Link copied.",
  passportViewWork: "See the work in the collection",
  passportBack: "All passports",
  ...
  productQrCopied: "Link copied.",
  productQrViewProduct: "View the work page",
  productQrMissing: "Work not found.",
  beforeRadTitle: "RAD before RAD",
  beforeRadBody:
    "Drag a finger or the mouse and watch idea become hand, material, and RAD.",
  beforeRadHint: "Drag",
  beforeRadIdea: "Idea",
  beforeRadHand: "Hand",
  beforeRadMaterial: "Material",
  beforeRadRad: "RAD",
  liveEyebrow: "Being made",
  liveHeadline: "RAD {code} is being made.",
  liveNow: "Now",
  liveDaysAgo: "{days} days since it began.",
  liveNotes: "Workshop notes",
  todayWorkshop: "Today in the workshop",
  archiveEyebrowFull: "RAD archive",
  ...
  familyEyebrow: "This RAD's family",
  familyBody: "They stay unique. They share DNA, not identical designs.",
  marksTitle: "Marks of the hand",
  marksBody:
    "We did not hide the making marks. Tap a point and see where it came from.",
  shapeEyebrow: "Discover",
  shapeTitle: "What shape is my RAD?",
  shapeBody: "Five short questions. Then three real pieces from the archive.",
  shapeResult: "You are probably this RAD:",
  shapeAgain: "Start over",
  ...
  titleArchive: "RAD archive",
  titleNow: "Now in the workshop",
  titleShape: "What shape is my RAD?",
