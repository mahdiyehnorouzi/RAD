export const fa = {
  ...
  orderStage10: "ارسال",
  shopStageReceived: "دریافت سفارش",
  shopStageApproved: "تأیید کارگاه",
  shopStageForming: "شکل‌دهی",
  shopStageDrying: "خشک‌کردن",
  shopStageFiring: "پخت",
  shopStageGlazing: "لعاب",
  shopStageQuality: "کنترل کیفیت",
  shopStageShipped: "ارسال",
  shopStageDelivered: "تحویل",
  ordersShopNote: "این صفحه سفارش‌های آماده فروشگاه است. سفارش اختصاصی را در مسیر ساخت ببینید.",
  makingCustomNote: "این صفحه فقط سفارش‌های اختصاصی شماست — نه خرید از آرشیو.",
